...
class Ui_GUIofAll(object):
    ...
    def clicked_btn(self):
        ...
        motorGroup1 = MotorControl(t, self.lineEdit.text(), self.lineEdit_2.text(),
                                   self.lineEdit_3.text(), self.lineEdit_4.text(), "MotorGroup1.ino")
        motorGroup1.startMotor()
        motorGroup2 = MotorControl(t, self.lineEdit_5.text(), self.lineEdit_6.text(),
                                   self.lineEdit_7.text(), self.lineEdit_8.text(), "MotorGroup2.ino")
        motorGroup2.startMotor()
        motorGroup3 = MotorControl(t, self.lineEdit_9.text(), self.lineEdit_10.text(),
