...
from project.HW.Section_II.GUIofAll.controlTest import MotorControl


class Ui_GUIofAll(object):
    def setupUi(self, GUIofAll):
        GUIofAll.setObjectName("GUIofAll")
        GUIofAll.resize(892, 613)
        GUIofAll.setStyleSheet("QWidget{\n"
                               "background-color:rgb(0, 0, 0)\n"
                               "}")
        self.label = QtWidgets.QLabel(GUIofAll)
        self.label.setGeometry(QtCore.QRect(60, 140, 171, 21))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(GUIofAll)
        self.label_2.setGeometry(QtCore.QRect(60, 190, 171, 21))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(GUIofAll)
        self.label_3.setGeometry(QtCore.QRect(60, 240, 171, 21))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(GUIofAll)
        self.label_4.setGeometry(QtCore.QRect(60, 290, 171, 21))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(GUIofAll)
        self.label_5.setGeometry(QtCore.QRect(60, 340, 171, 21))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(GUIofAll)
        self.label_6.setGeometry(QtCore.QRect(60, 390, 171, 21))
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(GUIofAll)
        self.label_7.setGeometry(QtCore.QRect(490, 140, 171, 21))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(GUIofAll)
        self.label_8.setGeometry(QtCore.QRect(490, 190, 171, 21))
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(GUIofAll)
        self.label_9.setGeometry(QtCore.QRect(490, 240, 171, 21))
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(GUIofAll)
        ...
        self.label_26 = QtWidgets.QLabel(GUIofAll)
        self.label_26.setGeometry(QtCore.QRect(60, 440, 231, 21))
        self.label_26.setObjectName("label_26")
        self.lineEdit_13 = QtWidgets.QLineEdit(GUIofAll)
        self.lineEdit_13.setGeometry(QtCore.QRect(320, 440, 101, 21))
        self.lineEdit_13.setStyleSheet("QWidget{\n"
                                       "background-color:rgb(255, 255, 255)\n"
                                       "}")
        self.lineEdit_13.setObjectName("lineEdit_13")
        self.label_27 = QtWidgets.QLabel(GUIofAll)
        self.label_27.setGeometry(QtCore.QRect(430, 440, 41, 21))
        self.label_27.setObjectName("label_27")

        self.retranslateUi(GUIofAll)
        QtCore.QMetaObject.connectSlotsByName(GUIofAll)

    def clicked_btn(self):
        t = int(self.lineEdit_13.text()) * 60 * 60 * 1000
        motorGroup1 = MotorControl(str(t), self.lineEdit.text(), self.lineEdit_2.text(),
                                   self.lineEdit_3.text(), self.lineEdit_4.text(), "MotorGroup1.ino")
        motorGroup1.startMotor()
        motorGroup2 = MotorControl(str(t), self.lineEdit_5.text(), self.lineEdit_6.text(),
                                   self.lineEdit_7.text(), self.lineEdit_8.text(), "MotorGroup2.ino")
        motorGroup2.startMotor()
        motorGroup3 = MotorControl(str(t), self.lineEdit_9.text(), self.lineEdit_10.text(),
                                   self.lineEdit_11.text(), self.lineEdit_12.text(), "MotorGroup3.ino")
        motorGroup3.startMotor()
        motorGroup1.openFile()

    def retranslateUi(self, GUIofAll):
        _translate = QtCore.QCoreApplication.translate
        GUIofAll.setWindowTitle(_translate("GUIofAll", "GUIofAll"))
        ...
        self.label_27.setText(_translate("GUIofAll",
                                         "<html><head/><body><p><span style=\" font-weight:600; color:#ffffff;\">hours</span></p></body></html>"))
