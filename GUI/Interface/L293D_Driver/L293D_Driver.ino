...
AF_DCMotor motor4(4);               // create motor #4, 64KHz pwm - linked to the M4 port on L293D driver
  ...
  int rpm1 = 500;                     // set a initial rotational speed 300rpm ~ 800rpm (recommended)
  int rpm2 = 500;                     // set a initial rotational speed 300rpm ~ 800rpm (recommended)
  int rpm3 = 500;                     // set a initial rotational speed 300rpm ~ 800rpm (recommended)
  int rpm4 = 500;                     // set a initial rotational speed 300rpm ~ 800rpm (recommended)
